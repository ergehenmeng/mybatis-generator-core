...
public abstract class IntrospectedTable {
    ...
    protected void calculateXmlAttributes() {
        ...
        setExampleWhereClauseId("ExampleWhereClause"); //$NON-NLS-1$
        setBaseColumnListId("BaseColumnList"); //$NON-NLS-1$
        setBlobColumnListId("BlobColumnList"); //$NON-NLS-1$
        setMyBatis3UpdateByExampleWhereClauseId("UpdateByExampleWhereClause"); //$NON-NLS-1$
    }
